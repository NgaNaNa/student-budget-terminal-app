...
puts "Welcome to The Student Budgeting App".cyan
puts "We're here to help you manage your money".cyan
...
def menu_calc_start_exit()
    ...
    puts "This week's total income is $#{weekly_budget[0].round(2)}."
